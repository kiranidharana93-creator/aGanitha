...
export const LoginModal: React.FC<LoginModalProps> = ({ onStudentLogin, onAdminLogin }) => {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-white flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white border-2 border-[#0052CC] rounded-2xl shadow-xl overflow-hidden my-8">
        {/* Header Branding Banner */}
        <div className="bg-[#0052CC] p-7 text-white text-center relative rounded-t-xl">
          <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-2xl bg-white text-[#0052CC] shadow-md">
        ...
        {/* Role Selection Tabs */}
        <div className="flex border-b-2 border-[#0052CC] bg-white p-2 gap-2">
          <button
            type="button"
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl font-bold text-xs transition-all cursor-pointer ${
              roleTab === 'student'
                ...
                : 'text-[#0052CC] hover:bg-[#0052CC]/10 border border-[#0052CC]'
            }`}
          >
          ...
          {roleTab === 'student' ? (
              ...
              <form onSubmit={handleStudentSubmit} className="space-y-4">
                <div className="space-y-1">
                  <label className="text-xs font-bold text-[#0052CC] block">
                    Student ID <span className="text-[#D32F2F]">*</span>
                  </label>
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-white border-2 border-[#0052CC] rounded-xl px-4 py-2.5 text-sm text-[#0052CC] placeholder-[#0052CC]/50 focus:outline-none focus:ring-2 focus:ring-[#0052CC] uppercase tracking-wider font-mono font-bold"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-white border-2 border-[#0052CC] rounded-xl pl-4 pr-11 py-2.5 text-sm text-[#0052CC] placeholder-[#0052CC]/50 focus:outline-none focus:ring-2 focus:ring-[#0052CC] font-bold"
                      required
                    />
                    <button
                      type="button"
                      onClick={() => setShowStudentPassword(!showStudentPassword)}
                      className="absolute right-3 top-1/2 -translate-y-1/2 text-[#0052CC] hover:opacity-80 p-1 cursor-pointer"
                ...
                {studentError && (
                  <div className="p-3 bg-white border-2 border-[#D32F2F] rounded-xl text-xs text-[#D32F2F] flex items-start gap-2">
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full bg-[#0052CC] hover:bg-[#0052CC]/90 text-white font-extrabold py-3.5 px-4 rounded-xl shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                  >
                    {isStudentLoading ? (
            ...
            <form onSubmit={handleAdminSubmit} className="space-y-5">
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-[#0052CC] block">
                  Admin Email <span className="text-[#D32F2F]">*</span>
                </label>
                <input
                  type="email"
                  value={adminEmail}
                  ...
                  className="w-full bg-white border-2 border-[#0052CC] rounded-xl px-4 py-3 text-sm text-[#0052CC] placeholder-[#0052CC]/50 focus:outline-none focus:ring-2 focus:ring-[#0052CC] font-bold"
                  required
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-white border-2 border-[#0052CC] rounded-xl pl-4 pr-11 py-3 text-sm text-[#0052CC] placeholder-[#0052CC]/50 focus:outline-none focus:ring-2 focus:ring-[#0052CC] font-bold"
                    required
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[#0052CC] hover:opacity-80 p-1 cursor-pointer focus:outline-none"
              ...
              {adminError && (
                <div className="p-3 bg-white border-2 border-[#D32F2F] rounded-xl text-xs text-[#D32F2F] font-bold flex items-center gap-2">
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="w-full bg-[#0052CC] hover:bg-[#0052CC]/90 text-white font-extrabold py-3.5 px-4 rounded-xl shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
